...
/**
 * Classe che implementa l'algoritmo AES-256-GCM in encryption e decryption. La
 * generazione della chiave è demandata all'utente in qualche altro modo (in
 * pratica i costruttori devono ricevere o una stringa di esadecimali, o un
 * array di byte, o la chiave già pronta).
 * 
 * @author emanuele
 * 
 */
public class AES_256_GCM_Crypto implements Crypto {
	...
	private final byte[] iv = {
			...
			(byte) 0x20, (byte) 0x21, }; // serve per generare i parametri per
											// il modo GCM
	 ...
	 * carattere esadecimale rappresenta un nibble da 4 bit --> 64*4 = 256 bit
	 * di chiave).
	 * 
	 * @param ptx
	...
	/**
	 * Costruttore in encrypt mode con plaintext e chiave sotto forma di stringa
	 * di array di byte; viene lanciata un'eccezione se l'array di byte è lungo
	 * meno di 32 byte (32*8 = 256 bit).
	 * 
	 * @param ptx
	 *            : il plaintext da cifrare
	 * @param keyValue
	...
	/**
	 * Costruttore in encrypt mode con plaintext e chiave passata già pronta; se
	 * la chiave non avrà la stessa lunchezza di una generata a partire da una
	 * stringa di 256 bit, allora viene lanciata un'eccezione.
	 * 
	 * @param ptx
	 *            : il plaintext da cifrare
	 * @param key
	...
	/**
	 * Costruttore in decrypt mode con chiave e ciphertext passato come stringa
