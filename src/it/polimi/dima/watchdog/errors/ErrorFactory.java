...
public class ErrorFactory {
	...
	public static final String BAD_PASSWORD = "The password must be 8-20 characters long and it must contain at least a number and a letter. Only these special characters are allowed:\n-_@%&#,;:./<!>=?`~";
